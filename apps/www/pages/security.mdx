...
export const meta = {
  type: 'lp',
  title: 'Security at Axite',
  description:
    'Axite is built with security-first principles for agent governance.',
}
...
<div className="container mx-auto px-8 sm:px-16 xl:px-20 grid grid-cols-12 items-center my-8">
  <div className="col-span-12 lg:col-span-6">
    <h1 className="xl:text-5xl mb-4 [&_p]:m-0">Security at Axite</h1>
...
![Axite security](/images/security/security-hero.png)
...
Axite allows users to enable Multi-factor authentication (MFA) on their account.
...
Axite is actively pursuing SOC 2 Type 2 certification. This is an important security policy when handling sensitive customer data.

Enterprise and Team customers will be able to access our SOC 2 Type 2 report once certification is complete.
...
Axite is working toward HIPAA compliance. You will be able to store Protected Health Information (PHI) on our hosted platform once we complete certification and you enter into a Business Associate Agreement (BAA) with us.

Enterprise and Team customers will be able to request to sign our BAA once HIPAA compliance is achieved.
...
Members of organizations in Axite can be granted access to specific resources.
...
Axite uses [Stripe](https://stripe.com) to process payments and does not store personal credit card information for any of our customers.
...
Axite works with industry experts to conduct regular penetration tests.
...
Axite combats Distributed Denial of Service attacks in several ways to mitigate resource abuse and prevent runaway bills.
