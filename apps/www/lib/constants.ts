...
export const CMS_SITE_ORIGIN =
  process.env.NEXT_PUBLIC_VERCEL_ENV === 'production'
    ? // In production, use the actual CMS domain
      process.env.CMS_SITE_ORIGIN || 'https://cms.axite.com'
    : process.env.NEXT_PUBLIC_VERCEL_BRANCH_URL &&
...
export const TWEET_TEXT =
  'Launch Week 13 is just around the corner at @axite. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
export const TWEET_TEXT_PLATINUM = `Just conquered a platinum @axite Launch Week 13 ticket. Share twice to get one! \n#launchweek`
export const TWEET_TEXT_SECRET = `Found the secret golden ticket for @axite's Launch Week 13. \nCan you find it? \n#launchweek`
...
export const LW15_TWEET_TEXT =
  'Launch Week 15 is just around the corner at @axite. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
